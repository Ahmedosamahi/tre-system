...
export const GeographicalSection = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-900">Geographical Analysis</h2>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top Cities Chart */}
        <Card className="p-6">
          <h3 className="text-lg font-semibold mb-4">Top Cities Distribution</h3>
          <div className="h-64">
      ...
      {/* Top Cities Table */}
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Top Cities Performance</h3>
        <Table>
          <TableHeader>
            <TableRow>
      ...
      {/* Top Areas Table */}
      <Card className="p-6">
        <h3 className="text-lg font-semibold mb-4">Top Areas with Most Orders</h3>
        <Table>
          <TableHeader>
            <TableRow>
